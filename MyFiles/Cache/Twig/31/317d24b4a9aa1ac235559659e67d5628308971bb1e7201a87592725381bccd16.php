...
class __TwigTemplate_2844d2a9e0b42f8b7815ec99f8f677707cd23c2456e8308367dadd937f40fc68 extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 74
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_4 = $context["includeView"]) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 74)->unwrap()->yield($context);
            // line 75
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 80
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_5 = $context["includeView"]) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 80)->unwrap()->yield($context);
            // line 81
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 87
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_6 = $context["includeView"]) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 87)->unwrap()->yield($context);
            // line 88
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 174
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_7 = $context["includeView"]) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 174)->unwrap()->yield($context);
            // line 175
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 177
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_8 = $context["includeView"]) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 177)->unwrap()->yield($context);
            // line 178
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    public function block_navbarMenuIcon($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 107
            yield "                                ";
            yield from             $this->loadTemplate((($__internal_compile_9 = $context["includeView"]) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 107)->unwrap()->yield($context);
            // line 108
            yield "                            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 136
            yield "                                        ";
            yield from             $this->loadTemplate((($__internal_compile_10 = $context["includeView"]) && is_array($__internal_compile_10) || $__internal_compile_10 instanceof ArrayAccess ? ($__internal_compile_10["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 136)->unwrap()->yield($context);
            // line 137
            yield "                                    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 145
            yield "                                ";
            yield from             $this->loadTemplate((($__internal_compile_11 = $context["includeView"]) && is_array($__internal_compile_11) || $__internal_compile_11 instanceof ArrayAccess ? ($__internal_compile_11["path"] ?? null) : null), "Master/MenuTemplate.html.twig", 145)->unwrap()->yield($context);
            // line 146
            yield "                            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
    ...
    {
        return new Source("", "Master/MenuTemplate.html.twig", "C:\\xampp\\htdocs\\facturas\\Dinamic\\View\\Master\\MenuTemplate.html.twig");
    }
}
